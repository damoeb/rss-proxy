  ...
  it('#findArticles works', () => {
    ...
    expect(articles[0]).to.eql({
      ...
      link: '/story/2000108150923/von-blaue-netzwerken-und-schwarzen-raechern-im-innenministerium',
        "description": [
          "Postenschacher",
          "Aus dem Innenministerium dringen immer mehr Details zu Umfärbungen in der Ära Kickl – die FPÖ vermutet \"schwarze Netzwerke\" hinter den Leaks",
          "361 Postings",
          "Von blauen Netzwerken und schwarzen Rächern im Innenministerium"
        ]
